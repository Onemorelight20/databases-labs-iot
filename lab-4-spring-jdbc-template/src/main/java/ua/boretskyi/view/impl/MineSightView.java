...
public class MineSightView implements GeneralView {
    ...
    public MineSightView(MineSightController mineSightController) {
        ...
        menu.put(BASE_NUM + "6", String.format(FIND_BY.getExplanation(), BASE_NUM + "6", TABLE_NAME, "company_id"));
        menu.put(BASE_NUM + "7", String.format(FIND_BY.getExplanation(), BASE_NUM + "7", TABLE_NAME, "title"));
